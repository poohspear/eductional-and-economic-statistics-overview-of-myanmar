...
<body>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <div id="chart_age_14_20_edu"></div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <div id="chart_age_14_20_eco"></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <div id="chart_age_20_40_edu"></div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <div id="chart_age_20_40_eco"></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <div id="chart_age_40_60_edu"></div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <div id="chart_age_40_60_eco"></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <div id="chart_age_60_60_edu"></div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <div id="chart_age_60_60_eco"></div>
                            </div>
                        </div>
                    </div>
    ...
    ";
            ...
            $sql = "SELECT * FROM `tbl_census_data` WHERE Age = '5 - 9' OR Age = '10 - 14'";
            ...
            //chart_age_0_14
            $edu_chart = "chart_age_20_40_edu";
            $eco_chart = "chart_age_20_40_eco";
            //$sql = "SELECT * FROM `tbl_census_data` WHERE Age = '5 - 9' AND  Age = '10 - 14'";
            $sql = "SELECT * FROM `tbl_census_data` WHERE Age = '20 - 24' OR Age = '25 - 29' OR Age = '25 - 29' OR Age = '35 - 39'";
            $chart_data = export_json($conn,$sql,$edu_chart,$eco_chart);
            //print_r($json_1);
            echo "\n". $chart_data['script'] . "\n";
            ...
            //chart_age_0_14
            $edu_chart = "chart_age_40_60_edu";
            $eco_chart = "chart_age_40_60_eco";
            //$sql = "SELECT * FROM `tbl_census_data` WHERE Age = '5 - 9' AND  Age = '10 - 14'";
            $sql = "SELECT * FROM `tbl_census_data` WHERE Age = '40 - 44' OR Age = '45 - 49' OR Age = '50 - 54' OR Age = '55 - 59'";
            $chart_data = export_json($conn,$sql,$edu_chart,$eco_chart);
            //print_r($json_1);
            echo "\n". $chart_data['script'] . "\n";
            ...
            //chart_age_0_14
            $edu_chart = "chart_age_60_60_edu";
            $eco_chart = "chart_age_60_60_eco";
            //$sql = "SELECT * FROM `tbl_census_data` WHERE Age = '5 - 9' AND  Age = '10 - 14'";
            $sql = "SELECT * FROM `tbl_census_data` WHERE Age = '60 - 64' OR Age = '65 - 69' OR Age = '70 - 74' OR Age = '75 - 79' OR Age = '80 - 84' OR Age = '85 - 89' OR Age = '90 +'";
            $chart_data = export_json($conn,$sql,$edu_chart,$eco_chart);
            //print_r($json_1);
            echo "\n". $chart_data['script'] . "\n";
            ?>
